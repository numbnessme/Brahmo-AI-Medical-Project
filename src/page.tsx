...
function DashboardContent() {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f1f5f9', fontFamily: 'system-ui, -apple-system, sans-serif', color: '#1e293b' }}>
      ...
      <nav style={{ backgroundColor: '#0f172a', color: 'white', padding: '16px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', boxShadow: '0 4px 20px rgba(15, 23, 42, 0.08)', position: 'sticky', top: 0, zIndex: 50 }}>
            ...
            <>
              ...
              <form onSubmit={handleCheckSafety} style={{ backgroundColor: 'white', padding: '24px', borderRadius: '16px', boxShadow: '0 4px 12px rgba(0,0,0,0.01)', border: '1px solid #e2e8f0' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #f1f5f9', paddingBottom: '16px', marginBottom: '20px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <div style={{ width: '40px', height: '40px', borderRadius: '50%', backgroundColor: '#f0f6ff', color: '#2563eb', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '15px' }}>
                ...
                <div style={{ backgroundColor: '#f8fafc', padding: '20px', borderRadius: '14px', border: '1px solid #e2e8f0', animation: 'statusPulse 2.5s infinite' }}>
                  ...
                  <button
                    ...
                    style={{ width: '100%', padding: '14px', backgroundColor: '#2563eb', color: 'white', border: 'none', borderRadius: '8px', fontSize: '14px', fontWeight: '700', cursor: 'pointer', transition: 'background 0.2s', opacity: isAiLoading ? 0.7 : 1, boxShadow: '0 4px 12px rgba(37, 99, 235, 0.15)' }}
                  >
                ...
                {activeAlerts.length === 0 ? (
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    {activeAlerts.map((alert, idx) => (
                      <div key={idx} style={{ padding: '16px', borderRadius: '10px', backgroundColor: alert.severity === 'CRITICAL' ? '#fef2f2' : '#fffbeb', borderLeft: `6px solid ${alert.severity === 'CRITICAL' ? '#dc2626' : '#d97706'}`, borderTop: '1px solid #f1f5f9', borderRight: '1px solid #f1f5f9', borderBottom: '1px solid #f1f5f9' }}>
                        ...
                        <small style={{ color: '#64748b', display: 'block', fontSize: '11px', backgroundColor: 'rgba(0,0,0,0.02)', padding: '6px 10px', borderRadius: '4px' }}><strong>Strategy Protocol Override:</strong> {alert.overrideStrategy}</small>
                      </div>
                    ))}
                  </div>
                )}
